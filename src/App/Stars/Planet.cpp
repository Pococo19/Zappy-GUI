...
zappy::Planet::Planet(const protocol::GUI_Map &map, std::shared_ptr<zap::ZapCamera> camera) : BasePlanet(camera)
{
    _init(map);
...
void zappy::Planet::setCamera(std::shared_ptr<zap::ZapCamera> camera)
{
...
void zappy::Planet::_init(const protocol::GUI_Map &map)
{
